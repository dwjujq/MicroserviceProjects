...
using Inventory.Common.Seed;
using Inventory.Extensions;
using Inventory.IRepository.Base;
using Inventory.Repository.Base;
using Inventory.Repository.MongoRepository;
...
namespace Inventory.Tests
{
    public class DI_Test
    {
        ...
        public IContainer DICollections()
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "Inventory.Services.dll");
            ...
            var repositoryDllFile = Path.Combine(basePath, "Inventory.Repository.dll");
