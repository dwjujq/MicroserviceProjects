...
using Inventory.Common.Caches;
using Inventory.Extensions;
using Inventory.Gateway.Extensions;
using Microsoft.AspNetCore.Authentication;
using System.Reflection;
using Inventory.Common.Caches.Interface;

namespace Inventory.AdminMvc
{
    public class Startup
    {
        ...
        */
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCustomSwaggerMildd(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("Inventory.Gateway.index.html"));
