...
[![sdk](https://img.shields.io/badge/sdk-6.0.1-d.svg)](#)  [![Build status](https://github.com/anjoy8/inventory/workflows/.NET%20Core/badge.svg)](https://github.com/anjoy8/Inventory/actions)  [![Build Status](https://dev.azure.com/laozhangisphi/anjoy8/_apis/build/status/anjoy8.Inventory?branchName=master)](https://dev.azure.com/laozhangisphi/anjoy8/_build?definitionId=1)  [![codecov](https://codecov.io/gh/anjoy8/Inventory/branch/master/graph/badge.svg)](https://codecov.io/gh/anjoy8/Inventory)  [![License MIT](https://img.shields.io/badge/license-Apache-blue.svg?style=flat-square)](https://github.com/anjoy8/Inventory/blob/master/LICENSE) [![star this repo](http://githubbadges.com/star.svg?user=anjoy8&repo=inventory&style=flat)](https://github.com/boennemann/badges)  [![fork this repo](http://githubbadges.com/fork.svg?user=anjoy8&repo=inventory&style=flat)](https://github.com/boennemann/badges/fork)  [![博客园](https://img.shields.io/badge/博客园-老张的哲学-brightgreen.svg)](https://www.cnblogs.com/laozhang-is-phi/)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=anjoy8/inventory&type=Date)](https://star-history.com/#anjoy8/inventory&Date)
...
-------------------------------
Inventory 开箱即用的企业级前后端分离【 .NET Core6.0 Api + Vue 2.x + RBAC】权限框架。  
其他版本看具体分支吧🎉  
...
**已被近100家公司所使用(🐱‍🚀)：[点击查看列表](https://github.com/anjoy8/Inventory/issues/75)**   欢迎盖楼，留下公司真实名字的，可得定制化指导服务。  
...
1、A~CoderDong:
应用场景：使用Inventory为基础骨架开发，搭建Client监控类守护进程项目，To C 客户群，
...
如果你的项目中借鉴了本项目，请稍微说明下[https://github.com/anjoy8/Inventory/issues/75](https://github.com/anjoy8/Inventory/issues/75)，开源不易✨。  
...
- [x] 封装`Inventory.Webapi.Template`项目模板，一键重建自己的项目 ✨；
...
`Inventory.Api`、`Inventory.Common`、`Inventory.IServices`、`Inventory.Model`、`Inventory.Repository`、`Inventory.Services`、`Inventory.Tasks`、`Inventory.Serilog`    
...
Thanks goes to these wonderful people ([✨](https://github.com/anjoy8/Inventory/graphs/contributors)):（排名暂时按提交顺序）  
  
    
<a href="https://github.com/anjoy8/inventory/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=anjoy8/inventory" />
</a>
<!-- prettier-ignore-end -->

This project follows the [all-contributors](https://github.com/anjoy8/Inventory/graphs/contributors) specification.
...
| ------- | -------- | ------- |
| [Inventory.Webapi.Template](https://www.nuget.org/packages/Inventory.Webapi.Template/) | [![Inventory.Webapi.Template](https://img.shields.io/nuget/v/Inventory.Webapi.Template.svg)](https://www.nuget.org/packages/Inventory.Webapi.Template/)  | [![Inventory.Webapi.Template](https://img.shields.io/nuget/dt/Inventory.Webapi.Template.svg)](https://www.nuget.org/packages/Inventory.Webapi.Template/) |
...
|[NetCore-Sugar-Demo](https://github.com/anjoy8/NetCore-Sugar-Demo)|[Blog.SplRepository.Demo](https://github.com/anjoy8/Blog.SplRepository.Demo)|[Inventory](https://github.com/anjoy8/Inventory)|[ChristDDD](https://github.com/anjoy8/ChristDDD)|
