...
Inventory is an enterprise-class back-to-back separation framework for.NET Core5.0 API + Vue 2.x + RBAC.
Website: http://apk.neters.club/.doc/
Has been used by several companies: [click to view list] (https://github.com/anjoy8/Inventory/issues/75)
...
If your project from the project, please explain a little bit down [https://github.com/anjoy8/Inventory/issues/75] (https://github.com/anjoy8/Inventory/issues/75), Open source is not easy ✨.
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/Inventory
