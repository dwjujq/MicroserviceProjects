...
using Inventory.Extensions.Apollo;
using Inventory.Extensions.Middlewares;
...
app.UseSwaggerMiddle(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("Inventory.Api.index.html"));
