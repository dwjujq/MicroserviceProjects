...
using Order.AuthHelper;
using Order.Common;
using Order.Common.AppConfig;
...
using Order.Repository.MongoRepository;
...
namespace Order.Tests
{
    public class DI_Test
    {
        ...
        public IContainer DICollections()
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "Order.Services.dll");
            ...
            var repositoryDllFile = Path.Combine(basePath, "Order.Repository.dll");
