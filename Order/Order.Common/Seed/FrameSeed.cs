...
namespace Order.Common.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.Api.Controllers", "Order.Api.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.Model", "Order.Model.Models", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.IRepository", "Order.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.IServices", "Order.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.Repository", "Order.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Order.Services", "Order.Services", tableNames, "", isMuti);
            return true;
        }
...
using Order.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Order.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Order.IRepository.UnitOfWork;
using Order.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using Order.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Order.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
