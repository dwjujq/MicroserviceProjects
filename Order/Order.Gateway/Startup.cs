...
using Order.Common;
using Order.Common.Caches;
using Order.Extensions;
using Order.Gateway.Extensions;
using Microsoft.AspNetCore.Authentication;
using System.Reflection;
using Order.Common.Caches.Interface;

namespace Order.AdminMvc
{
    public class Startup
    {
        ...
        */
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCustomSwaggerMildd(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("Order.Gateway.index.html"));
